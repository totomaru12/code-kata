...
class Bowling180828 {
    ...
    func score() -> Int {
        var score = 0
        var rollIndex = 0
        for _ in 0..<Bowling180828.NORMAL_FRAME_MAX {
    ...
    func isStrike(rollIndex: Int) -> Bool {
        return Bowling180828.SCORE_MAX_IN_FRAME == rolls[rollIndex]
    }
    
    func isSpare(rollIndex: Int) -> Bool {
        return Bowling180828.SCORE_MAX_IN_FRAME == rolls[rollIndex] + rolls[rollIndex + 1]
    }
    
    func scoreStrike(rollIndex: Int) -> Int {
        return Bowling180828.SCORE_MAX_IN_FRAME + rolls[rollIndex + 1] + rolls[rollIndex + 2]
    }
    
    func scoreSpare(rollIndex: Int) -> Int {
        return Bowling180828.SCORE_MAX_IN_FRAME + rolls[rollIndex + 2]
    }
