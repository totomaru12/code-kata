...
class Bowling180813 {
    ...
    func isStrike(rollIndex: Int) -> Bool {
        return Bowling180813.SCORE_MAX_IN_FRAME == rolls[rollIndex]
    }
    
    func isSpare(rollIndex: Int) -> Bool {
        return Bowling180813.SCORE_MAX_IN_FRAME == rolls[rollIndex] + rolls[rollIndex + 1]
    }
    
    func scoreStrike(rollIndex: Int) -> Int {
        return Bowling180813.SCORE_MAX_IN_FRAME + rolls[rollIndex + 1] + rolls[rollIndex + 2]
    }
    
    func scoreSpare(rollIndex: Int) -> Int {
        return Bowling180813.SCORE_MAX_IN_FRAME + rolls[rollIndex + 2]
    }
