...
class Bowling180828Tests: XCTestCase {
    ...
    func testAllStrikes() {
        ...
        for _ in 0..<Bowling180828.NORMAL_FRAME_MAX {
            b.roll(pins: Bowling180828.SCORE_MAX_IN_FRAME)
        }
        b.roll(pins: Bowling180828.SCORE_MAX_IN_FRAME)
        b.roll(pins: Bowling180828.SCORE_MAX_IN_FRAME)
    ...
    func testAllFramesWith8And1() {
        ...
        XCTAssert(90 == b.score(), "all frames with 8 and 1 should be 90")
    }
