...
namespace PhpKata180824;

class Bowling180824
{
    public const NORMAL_FRAME_MAX = 10;
    public const SOCRE_MAX_IN_FRAME = 10;
    ...
    {
        return self::SOCRE_MAX_IN_FRAME == $this->rolls[$rollIndex];
    }

    private function isSpare($rollIndex)
    {
        return self::SOCRE_MAX_IN_FRAME == ($this->rolls[$rollIndex] + $this->rolls[$rollIndex + 1]);
    }

    private function scoreStrike($rollIndex)
    {
        return self::SOCRE_MAX_IN_FRAME + $this->rolls[$rollIndex + 1] + $this->rolls[$rollIndex + 2];
    }

    private function scoreSpare($rollIndex)
    {
        return self::SOCRE_MAX_IN_FRAME + $this->rolls[$rollIndex + 2];
    }
